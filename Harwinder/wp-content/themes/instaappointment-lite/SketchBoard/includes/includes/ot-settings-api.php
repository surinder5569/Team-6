      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            $sktlink = "http://www.sketchthemes.com/themes/instaappointment-responsive-appointment-booking-wordpress-theme/";
			      $sktratelink = "http://wordpress.org/support/view/theme-reviews/instaappointment-lite";
            
            echo '	<div class="donate-info">
					<strong>'. __( "To Activate All Features, Please Upgrade to Pro version!", "instaappointment-lite" ) .'</strong><br/>
					<a title="'. __( "Upgrade to Pro", "instaappointment-lite" ) .'" href="'. esc_url($sktlink) .'" target="_blank" class="upgrade">'. __( "Upgrade to Pro", "instaappointment-lite" ) .'</a>	<a title="'. __( 'Setup Instructions', 'instaappointment-lite' ) .'" href="'. get_template_directory_uri().'/Installation_Instructions.txt' .'" target="_blank" class="donate">'. __( 'Setup Instructions', 'instaappointment-lite' ) .'</a>
					<a title="'. __( 'Rate Insta Appointment Lite', 'instaappointment-lite' ) .'" href="'. esc_url($sktratelink) .'" target="_blank" class="review">'. __( 'Rate InstaAppointment Lite', 'instaappointment-lite' ) .'</a>
          </div>
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-version"><span>Version ' . INSTAAPP_THEME_VERSION . '</span></li>';
